...
#!
#! ---------------------------------------------------------
#TEMPLATE(KCR_CoolTips,'Devuna CoolTips ABC Templates'),FAMILY('ABC')
#HELP('COOLTIPS.HLP')
#!
#! ---------------------------------------------------------
...
#!
#!----------------------------------------------------------------------------------------------
#! Modified By Devuna 2009.05.23
#! fixed generation of include statement
#!----------------------------------------------------------------------------------------------
#!
#!----------------------------------------------------------------------------------------------
...
#!----------------------------------------------------------------------------------------------
#!
#EXTENSION(KCR_GlobalCoolTips,'Devuna Global Cooltip Extension'),Application(KCR_CoolTip(KCR_CoolTips))
...
#!Modified By Devuna 2009.05.23
  #IF(NOT %DontApply)
    #ADD(%GlobalIncludeList,'COOLTIPS.INC')
  #ENDIF
#ENDAT
#!
#!
#!Modified By Devuna 7.0
#AT(%WindowManagerMethodDataSection,'Open','()'),PRIORITY(5000),WHERE(NOT %DontApply)
tt_ctrl  LONG
#ENDAT
#!
#!
...
%ToolTipFeq{PROP:HIDE} = FALSE
  ...
  #ENDFOR
#!-----------------------------------------------------------------------------------------
#! Modified by Devuna to support LANSRAD to support TipLink 7.0
#!-----------------------------------------------------------------------------------------
#IF(%TipLink=0)
...
#SYSTEM
 #TAB('Devuna CoolTip Templates')
  #INSERT  (%SysHead)
  #BOXED   ('About Devuna CoolTip Templates'),AT(5)
    #DISPLAY (''),AT(15)
...
#GROUP   (%MakeHead,%xTplName,%xTplDescription,%xTplVersion)
  #SET (%TplName,%xTplName & ' Version ' & %xTplVersion)
...
#!-----------------------------------------------------------------------------------------------------------
#GROUP   (%SysHead)
  #IMAGE   ('CoolTips.ico'), AT(,4,175,26)
  #DISPLAY ('CoolTips.tpl'),AT(40,4)
  #DISPLAY ('Devuna CoolTips ABC Templates'),AT(40,12)
  #DISPLAY ('for Clarion ABC Template Applications'),AT(40,20)
  #DISPLAY ('')
#!
#!-----------------------------------------------------------------------------------------------------------
#GROUP(%EmbedStart)
